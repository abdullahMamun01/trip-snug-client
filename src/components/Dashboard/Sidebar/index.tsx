...
import { FaBookmark, FaHotel } from "react-icons/fa";
...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      {
        icon: (
          <FaHotel className="fill-current" />
        ),
        label: "Hotels",
        route: "/hotels",
        children: [{ label: "manage", route: "/hotels/manage" }],
      },
      {
        icon: (
        ...
        label: "Bookings",
        route: "/bookings",
        children: [{ label: "bookings", route: "/bookings" } , { label: "Cancel-Bookings", route: "/bookings/cancel" }],
      },
      {
        icon: (
          <User className="fill-current w-5 h-5"/>
        ),
        label: "Users",
        route: "/users",
      ...
      {
        icon: (
          <MdOutlinePayment  className="fill-current" />
        ),
        label: "Payments",
        route: "/payments",
      },
      {
        icon: (
          <VscPreview  className="fill-current" />
        ),
        label: "Reviews",
        route: "/reviews",
      },
