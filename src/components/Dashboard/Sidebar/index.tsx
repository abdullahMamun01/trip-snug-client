...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      {
        icon: <FaHotel className="fill-current" />,
        label: "Hotels",
        route: "/hotels",
        children: [{ label: "manage", route: "/hotels/manage" }],
      },
      {
        icon: <FaBookmark className="fill-current" />,
        label: "Bookings",
        route: "/bookings",
        children: [
          { label: "bookings", route: "/bookings" },
          { label: "Cancel-Bookings", route: "/bookings/cancel" },
        ],
      },
      {
      ...
      {
        icon: <MdOutlinePayment className="fill-current" />,
        label: "Payments",
        route: "/payments",
      },
      {
        icon: <VscPreview className="fill-current" />,
        label: "Reviews",
        route: "/reviews",
      },
