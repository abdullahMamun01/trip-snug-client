  ...
  return (
    ...
    >
      <Button
        type='button'
        className={cn(
          'pointer-events-auto left-0 h-fit w-fit rounded-full bg-zinc-50 p-2 transition-opacity duration-300 dark:bg-zinc-950',
          alwaysShow
            ? 'opacity-100'
      ...
      <Button
        type='button'
        className={cn(
          'pointer-events-auto right-0 h-fit w-fit rounded-full bg-zinc-50 p-2 transition-opacity duration-300 dark:bg-zinc-950',
          alwaysShow
            ? 'opacity-100'
            : 'opacity-0 group-hover/hover:opacity-100',
          alwaysShow
